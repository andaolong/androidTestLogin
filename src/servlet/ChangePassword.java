...
public class ChangePassword {
	...
	public static MessageBean changePassword02(int cmd,String username, String oldPassword,String newPassword ) {
		...
		messageBean=dbUtils.changePasswordInDB(cmd,username, oldPassword,newPassword);	
